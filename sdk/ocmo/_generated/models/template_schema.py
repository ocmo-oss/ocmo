...
if TYPE_CHECKING:
    from ..models.template_schema_tags import TemplateSchemaTags


T = TypeVar("T", bound="TemplateSchema")
...
class TemplateSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        tags = TemplateSchemaTags.from_dict(d.pop("tags"))
        ...
        template_schema.additional_properties = d
