...
if TYPE_CHECKING:
    from ..models.secret_schema_tags import SecretSchemaTags


T = TypeVar("T", bound="SecretSchema")
...
class SecretSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        tags = SecretSchemaTags.from_dict(d.pop("tags"))
        ...
        secret_schema.additional_properties = d
