...
if TYPE_CHECKING:
    from ..models.config_schema_tags import ConfigSchemaTags
...
class ConfigSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        tags = ConfigSchemaTags.from_dict(d.pop("tags"))
        ...
        config_schema.additional_properties = d
