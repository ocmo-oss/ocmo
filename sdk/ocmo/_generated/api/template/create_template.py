...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": f"/api/v1/ns/{namespace}/~template/~create/{path}",
    }
        ...
        def _parse_response_201(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                response_201_type_0 = ConfigSchemaExtended.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                response_201_type_1 = TemplateSchemaExtended.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                response_201_type_2 = SecretSchemaExtended.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                response_201_type_3 = ResolverSchema.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            response_201_type_4 = FolderSchema.from_dict(data)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        namespace (str):
        path (str):
        body (str): Jinja2 template source.
        body (File):
