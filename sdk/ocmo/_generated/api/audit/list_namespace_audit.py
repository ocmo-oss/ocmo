...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v1/ns/{namespace}/~audit/",
        "params": params,
    }
...
) -> Optional[Union[ErrorSchema, PagedAuditEventSchema]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorSchema, PagedAuditEventSchema]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ErrorSchema, PagedAuditEventSchema]
    """
