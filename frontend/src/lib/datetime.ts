...
export function formatUserDateTimeShort(value: string | Date | number | null | undefined): string {
  return formatUserDateTime(value, 'short')
}

export function formatUserDateTimeLong(value: string | Date | number | null | undefined): string {
  return formatUserDateTime(value, 'long')
}

export function formatUserDateTimeRelative(value: string | Date | number | null | undefined): string {
  const date = toDate(value)
  if (!date) return '—'
...
export function formatUserDateTimeBucketRange(
  ...
  const sameYear = isSameCalendarYear(startDate, reference)
