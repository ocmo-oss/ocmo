...
import { parseDeletePreviewLine, parseDeletePreviewLines } from '../deletePreview'

describe('parseDeletePreviewLine', () => {
  it('parses tree item entries', () => {
    expect(parseDeletePreviewLine('my-first-namespace:: Folder:: test/empty/soempty')).toEqual({
      type: 'folder',
...
describe('parseDeletePreviewLines', () => {
  it('parses multiple lines', () => {
    expect(parseDeletePreviewLines([
      'prod:: Folder:: app',
      'prod:: Config:: app/api',
    ])).toEqual([
