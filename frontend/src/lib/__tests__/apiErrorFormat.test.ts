  ...
  it('joins validation error lists with newlines', () => {
    expect(
      formatServerErrorDetail({
        error: ['name: Field required', 'description: String should have at most 4096 characters'],
        errors: ['name: Field required', 'description: String should have at most 4096 characters'],
      }),
