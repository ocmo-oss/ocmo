...
export function arrayItemLinePrefix(line: string): { dashEndColumn: number; hasDash: boolean } | null {
...
export function formatScalarArrayItemInsertText(line: string, insertText: string): string {
