...
export const NOT_FOUND_TIMING: EmbroideryTiming = {
  groupStepMs: 25,
  slotStepMs: 1,
};
export const RESOLVE_TIMING: EmbroideryTiming = {
  groupStepMs: 12,
  slotStepMs: 1,
};
...
export function readBandColors(root: HTMLElement): BandColors {
  ...
  return {
    ...
    accentBottom:
      style.getPropertyValue("--vy-accent-bottom").trim() || "#2563eb",
  };
}
