...
const router = createBrowserRouter(
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'audit', element: <RequireGlobalAdmin><GlobalAuditPage /></RequireGlobalAdmin> },
      { path: 'audit/:eventId', element: <RequireGlobalAdmin><GlobalAuditPage /></RequireGlobalAdmin> },
      { path: 'permissions/global', element: <RequireGlobalAdmin><GlobalPermissionsPage /></RequireGlobalAdmin> },
