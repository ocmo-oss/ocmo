...
export const permissionsApi = {
  list: (params?: { limit?: number; offset?: number }, signal?: AbortSignal) =>
    api.get<GlobalPermissionRulesList>('/global-permissions/', { params, signal }),
  ...
  delete: (ruleId: string) =>
    api.delete<void>(`/global-permissions/${ruleId}`),

  move: (ruleId: string, payload: GlobalPermissionMovePaylod) =>
    api.post<GlobalPermissionRule>(`/global-permissions/${ruleId}/~move/`, payload),
}
