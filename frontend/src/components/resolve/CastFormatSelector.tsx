...
export function CastFormatSelector({ value, onChange }: CastFormatSelectorProps) {
  ...
  const filtered = useMemo(() => {
    ...
    return formats.filter(f => f.format.toLowerCase().includes(normalizedQuery))
        ...
        <>
          ...
          <div className="absolute left-0 right-0 top-full z-40 mt-1 rounded-lg border bg-surface-elevated shadow-lg dark:border-gray-700 dark:bg-gray-900">
            ...
            <div ref={listRef} className="max-h-48 overflow-y-auto">
              ...
              {isLoading && <p className="px-3 py-2 text-xs text-gray-400">Loading…</p>}
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      value === item.format && 'bg-brand-50 dark:bg-brand-900/20',
