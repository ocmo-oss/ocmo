...
export function Modal({ open, onClose, title, children, size = 'md', footer }: ModalProps) {
  ...
  const modalId = useId()
  const modalNotification = useNotifications(s => s.modalNotifications[modalId])
  const clearModalNotification = useNotifications(s => s.clearModalNotification)
  ...
  return (
    ...
    >
      <div className={cn(
        ...
        {modalNotification && <ModalNotificationBanner notification={modalNotification} />}
