import type { BuiltinNamespacePaths, ItemType, ReservedTags, VersionResponse } from '../api/types'
...
export function allBuiltinNamespacePaths(paths: BuiltinNamespacePaths): Set<string> {
...
export function reservedTagsForItemType(
  ...
  if (itemType === 'config' || itemType === 'template' || itemType === 'secret') {
